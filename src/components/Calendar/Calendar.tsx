  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        nav_button: cn('size-7 p-0 opacity-50 hover:opacity-100'),
        ...
        day: cn('size-9 p-0 aria-selected:opacity-100'),
        day_selected:
      ...
      components={{
        IconLeft: ({ ...props }) => <HiChevronLeft className="size-4" />,
        IconRight: ({ ...props }) => <HiChevronRight className="size-4" />,
      }}
