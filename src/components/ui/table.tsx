...
>(({ className, ...props }, ref) => (
  <tr
    ref={ref}
    className={cn(
      'order-b h-[60px] transition-colors data-[state=selected]:bg-muted ',
      className,
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <td
    ref={ref}
    className={cn(
      'border-secondary-70 hover:bg-opacity/25 h-[60px] border-t-2 p-4 text-center align-middle [&:has([role=checkbox])]:pr-0',
      className,
    )}
    {...props}
  />
