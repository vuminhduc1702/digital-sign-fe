...
>(({ className, children, ...props }, ref) => {
  return (
    <SelectPrimitive.Trigger
      ref={ref}
      className={cn(
        'bg-background ring-offset-background placeholder:text-muted-foreground flex h-10 w-full items-center justify-between rounded-md border border-secondary-600 px-3 py-2 text-sm focus:outline-none  focus-visible:ring-0 disabled:cursor-not-allowed disabled:bg-secondary-500 [&>span]:line-clamp-1',
