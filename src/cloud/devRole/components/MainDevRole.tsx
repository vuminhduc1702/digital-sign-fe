...
import { useDevGetRoles } from '../api'
import { type Role } from '../types'
import { ComboBoxSelectDevRole } from './ComboBoxSelectDevRole'
import { CreateDevRole } from './CreateDevRole'
import { DevRoleTable } from './DevRoleTable'

export function MainDevRole() {
  ...
  const { data, isPreviousData } = useDevGetRoles({ projectId })
        ...
        <div className="flex justify-end">
          {projectId && (
            <div className="flex items-center gap-x-3">
              <CreateDevRole projectId={projectId} />
              <ComboBoxSelectDevRole
                data={data?.roles || []}
